...
- **Keyboard shortcuts:** hover a thread and press **Alt+N** (note), **Alt+M** (move to section), or **Alt+↑/↓** (reorder it within its shelf or the "Everything else" pile). In an open conversation, Alt+N edits its note in place. Alt combos never collide with Gmail's own single-key shortcuts.
