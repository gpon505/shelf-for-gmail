...
> (~51s, 1280×800, with an original synthesized backing track — composed in
> the repo's tooling, so licensing is unambiguously ours) and `store/video/shelf-demo.gif` (the build-it beats),
